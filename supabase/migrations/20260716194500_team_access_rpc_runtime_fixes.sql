-- Corrige tipos de retorno das RPCs publicas da Etapa 3 e reconcilia
-- um overload legado da Etapa 2C sem remover compatibilidade.
...
GRANT EXECUTE ON FUNCTION public.consume_team_edit_token(text, text, text)
  TO service_role;
REVOKE ALL ON FUNCTION public.get_team_edit_session(text)
  FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_team_edit_session(text)
  TO service_role;
