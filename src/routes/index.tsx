...
const MODULES = [
  {
    icon: Trophy,
    title: "Campeonatos",
    text: "Temporadas, fases, grupos e regras de disputa em uma operação centralizada.",
  },
  {
    icon: Users,
    title: "Equipes & atletas",
    text: "Elencos, documentos, status de inscrição e histórico competitivo.",
  },
  {
    icon: Radio,
    title: "Súmula ao vivo",
    text: "Eventos de jogo, cartões, gols e substituições registrados no celular.",
  },
  {
    icon: BarChart3,
    title: "Estatísticas",
    text: "Classificação, artilharia e indicadores prontos para organizadores e público.",
  },
  {
    icon: WalletCards,
    title: "Financeiro",
    text: "Controle receitas, despesas, patrocinadores e prestação de contas.",
  },
  {
    icon: Globe2,
    title: "Portal público",
    text: "Landing da competição com agenda, notícias, ranking e resultados.",
  },
];
      ...
      <header className="sticky top-0 z-30 border-b border-white/[0.06] bg-background/82 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-5 px-4 sm:px-6 lg:px-8">
          ...
          <nav className="hidden items-center gap-7 text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground md:flex">
            <a href="#produto" className="transition hover:text-neon">
              Produto
            </a>
            <a href="#modulos" className="transition hover:text-neon">
              Módulos
            </a>
            <a href="#publico" className="transition hover:text-neon">
              Página pública
            </a>
          </nav>
          <div className="flex items-center gap-2">
            <Link
              to="/auth"
              className="hidden text-xs font-semibold text-muted-foreground transition hover:text-neon sm:block"
            >
              Entrar
            </Link>
              ...
              <div className="card-arena overflow-hidden p-3 shadow-elevated">
                <div className="rounded-xl border border-white/[0.06] bg-background/72 p-3">
                  <div className="flex items-center justify-between border-b border-white/[0.06] pb-3">
                    ...
                    <span className="rounded-md border border-neon/25 bg-neon/10 px-2 py-1 text-[10px] font-bold text-neon">
                      88'
                    </span>
                  </div>
          ...
          <div className="mx-auto grid max-w-7xl gap-6 px-4 py-16 sm:px-6 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
            <div className="self-center">
              ...
              <p className="mt-4 max-w-lg text-sm leading-7 text-muted-foreground">
                ...
                classificação, artilharia e próximos jogos — pronta para atletas, torcedores e
                patrocinadores.
              </p>
              <ul className="mt-6 space-y-3 text-sm text-muted-foreground">
                {[
                  "Layout responsivo para mobile",
                  "Ranking e tabela sempre visíveis",
                  "Espaços para patrocinadores e notícias",
                ].map((item) => (
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="grid gap-3 md:grid-cols-3">
            {[
              {
                icon: ShieldCheck,
                title: "Seguro por organização",
                text: "Dados separados por organizador, com permissões e autenticação.",
              },
              {
                icon: Smartphone,
                title: "Mobile-first em campo",
                text: "Fluxos rápidos para registrar jogo, atletas e eventos ao vivo.",
              },
              {
                icon: CalendarCheck,
                title: "Rotina operacional",
                text: "Agenda, status, filtros e módulos preparados para crescer.",
              },
            ].map((item) => (
