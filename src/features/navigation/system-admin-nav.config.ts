...
export const SYSTEM_ADMIN_NAV = [
  ...
  { to: "/system-admin/organizacoes", label: "Organizações e clientes", icon: Building2, available: false },
  { to: "/system-admin/usuarios", label: "Usuários", icon: Users, available: false },
  { to: "/system-admin/campeonatos", label: "Campeonatos e conteúdo", icon: Trophy, available: false },
  { to: "/system-admin/assinaturas", label: "Planos e assinaturas", icon: CreditCard, available: false },
  ...
  { to: "/system-admin/configuracoes", label: "Configuração da plataforma", icon: Settings, available: false },
